...
import {addIncome, getIncome} from '../../redux/transaction/transactions-operations';
...
const Income = () => {
    ...
    const summaryIncome = useAppSelector(selectTransactionsIncomes);
    console.log('summaryIncome', summaryIncome)
